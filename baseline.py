...
Original file is located at
    https://colab.research.google.com/drive/10FA6aPc-BhybvLJRuqsrOylsjovtMgdS
"""
...
base_dir = "/content/baseline_split"
...
model = Model(inputs=base_model.input, outputs=predictions, name="VGG19_Baseline")
